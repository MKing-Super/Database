...
![](E:\github_projects\Database\MySQL\images\散列表示意图0.png)
...
![](E:\github_projects\Database\MySQL\images\链表0.png)
...
![](E:\github_projects\Database\MySQL\images\跳表0.png)
...
![](E:\github_projects\Database\MySQL\images\平衡二叉树0.png)
...
![](E:\github_projects\Database\MySQL\images\B+树0.png)
...
![](E:\github_projects\Database\MySQL\images\二叉树0.png)

![](E:\github_projects\Database\MySQL\images\五叉树0.png)

​		可以看到如果用二叉树 ，要遍历 5 个节点，如果用五叉树 ，只要遍历 3 次，一下少了两次磁盘 IO，回过头来看 上文的一亿个节点，如果我们用 100 叉树来构建，需要几次 IO 呢？

![](E:\github_projects\Database\MySQL\images\100叉树0.png)
...
![](E:\github_projects\Database\MySQL\images\页分裂与页合并3.png)

​		有页分裂就必然有页合并，什么时候会发生页合并呢，当删除表记录的时候，索引也要删除，此时就有可能发生页合并，如图示：

![](E:\github_projects\Database\MySQL\images\页分裂与页合并4.png)
...
![](E:\github_projects\Database\MySQL\images\根据索引查找行记录0.png)
